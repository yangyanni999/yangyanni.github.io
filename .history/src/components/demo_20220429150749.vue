...
const vCopy={
  mounted(el:HTMLElement,binding:any) {
    // el如果为HTMLElement类型，targetContent报错捏
    ...
    */
    ...
    el.addEventListener('click',()=>{
      if(!el.targetContent) return (console.log('无复制内容'))
      if(navigator.clipboard){
          navigator.clipboard.writeText(el.targetContent)
      }
      else {
...
指定v-copy练习：
<button v-copy="content">点击复制</button>
